  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-[50%] mx-6 p-6  hidden sm:flex ">
          <div
          ...
          <div className="">
            <div className="rounded-xl sm:block  p-6 bg-[#141414]">
              <h2 className="text-2xl font-semibold mb-4 text-white">Рассписание</h2>
            </div>
          </div>
        </div>
